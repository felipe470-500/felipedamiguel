    ...
    <main className="min-h-screen bg-background text-foreground">
      <header className="border-b border-border bg-card">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6">
          ...
          <div className="flex items-center gap-2"><Button asChild variant="outline" size="sm"><Link to="/integracoes/mercado-livre" search={{}}>Mercado Livre</Link></Button><Button asChild variant="outline" size="sm"><Link to="/admin">Painel atual</Link></Button><Button variant="ghost" size="icon" aria-label="Sair" title="Sair" onClick={signOut}><LogOut className="size-4" /></Button></div>
        </div>
      </header>
